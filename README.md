...
장점: 실시간으로 시스템 상태를 모니터링 할 수 있어 문제 발생 시 빠르게 대응 가능, 다양한 정렬 및 필터링 기능을 통해 필요한 정보를 효율족으로 추출 가능, 상호작용 키를 통해 동적으로 모니터링 화면을 조절 가능
단점: 실시간 업데이트로 인해 시스템 자원을 소모할 가능성 높음, 대량의 프로세스 정보를 다루기 어려
...
<img width="855" alt="image" src="https://github.com/ssswoowoook/opensw/assets/170293211/d3fd37b8-db8d-4d57-9b4b-fa24429a42aa">
...
리눅스에서 kill 명령어를 사용하여 프로세스를 종료 가능. 이를 통해 원하는 프로세스를 간편하게 제어하고 운영체제의 안정성을 유지 가능 but, kill 명령어 사용 시 주의가 필요
